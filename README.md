...
# Dashboard
The dashboard can be found in [Tableau Public](https://public.tableau.com/app/profile/orawan.charoensukmongkol/viz/Row_Health/Dashboard1). This dashboard enables users to filter by plan, campaign type, and state, and focuses on trends and values in marketing metrics, signup metrics, and claim metrics.
